...
package br.com.animvs.koalory.entities.engine.graphics.tiles;
 ...
 * @author Nathan Sweet
 */
public class TileRenderer implements TiledMapRenderer, Disposable {
    ...
    private static final int CACHE_SIZE = 5460;
